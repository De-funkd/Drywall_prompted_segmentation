...
def convert_coco_to_binary_masks(coco_json_path, images_base_dir, output_masks_dir, output_images_dir, dataset_type="cracks"):
    """
    ...
    for ann in coco_data['annotations']:
        ...
        if img_path is None:
            ...
            skipped_images.append((img_filename, "File not found"))
            continue
        ...
        if img is None:
            ...
            skipped_images.append((img_filename, "Could not load image"))
            continue
    ...
    return len(processed_images), len(skipped_images), skipped_images

def process_dataset(dataset_name, dataset_path, output_base_dir, dataset_type="cracks"):
    """
    ...
    for split in splits:
        ...
        if os.path.exists(split_path):
            ...
            if os.path.exists(annotation_file):
                ...
                processed_count, skipped_count, skipped_list = convert_coco_to_binary_masks(
                    annotation_file, 
...
def main():
    ...
    cracks_processed, cracks_skipped = process_dataset(
        "cracks",
        cracks_input_dir,
        cracks_output_dir,
        "cracks"
    ...
    taping_processed, taping_skipped = process_dataset(
        "drywall-join-detect",
        taping_input_dir,
        taping_output_dir,
